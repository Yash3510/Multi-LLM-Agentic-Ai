...
# Rebranded under the LICENSE's <50-user exemption (docs.openwebui.com/license);
# revisit before any deployment past that threshold.
WEBUI_NAME = os.getenv('WEBUI_NAME', '4CE')

...
**Related:** [Project README](../../README.md) · [Plugin sources](../README.md) · [Original architecture spec (`Multi-LLM-Docs`)](https://github.com/Yash3510/Multi-LLM-Agentic-Ai/blob/main/docs/architecture/00_MASTER_ARCHITECTURE.md)
...
**Fallback worth preserving:** the existing [`Multi-LLM-Docs`](https://github.com/Yash3510/Multi-LLM-Agentic-Ai/blob/main/README.md) prototype is tested and works end to end. Do not delete or rewrite it. If the fork isn't demo-ready by day 5, that repo is the demo.
